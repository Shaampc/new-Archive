...
$(document)['ready'](function () {
        $('#nqnia-prot')['html']('<a href="http://nqnia.blogspot.com" rel="dofollow" target="_blank">Design: - NQnia</a>');
        setInterval(function () {
                if (!$('#nqnia-prot:visible')['length']) {
                  window['location']['href'] = 'http://nqnia.blogspot.com';
                };
            }, 3000);
    });
//]]>